	...
	<body>
		...
		<div id="show-pessoa" class="content scaffold-show" role="main">
			...
			<ol class="property-list pessoa">
				...
				<g:if test="${pessoaInstance?.dataDeNascimento}">
				<li class="fieldcontain">
					<span id="dataDeNascimento-label" class="property-label"><g:message code="pessoa.dataDeNascimento.label" default="Data De Nascimento" /></span>
					
						<span class="property-value" aria-labelledby="dataDeNascimento-label"><g:formatDate date="${pessoaInstance?.dataDeNascimento}" /></span>
